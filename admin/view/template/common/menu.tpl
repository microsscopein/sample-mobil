<ul id="menu">
  <li id="beranda"><a href="<?php echo $home; ?>"><i class="fa fa-home fa-fw"></i> <span><?php echo $text_dashboard; ?></span></a></li>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-book fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
    <ul>
